...
class WorkbookXform extends BaseXform {
  ...
  prepare(model) {
    ...
    (model.charts || []).forEach((chart, i) => {
      // assign name
      chart.name = chart.name || `chart${i + 1}`;
      chart.style = chart.style || `style${i + 1}`;
      chart.colors = chart.colors || `colors${i + 1}`;
      chart.rels = chart.rels || [
        {Id: 'rId2', Type: 'http://schemas.microsoft.com/office/2011/relationships/chartColorStyle', Target: `${chart.colors}.xml`},
        {Id: 'rId1', Type: 'http://schemas.microsoft.com/office/2011/relationships/chartStyle', Target: `${chart.style}.xml`},
      ];
    });
  }
