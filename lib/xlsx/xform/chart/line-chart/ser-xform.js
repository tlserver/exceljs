...
const CatXform = require('../cat-xform');
const ValXform = require('../val-xform');
...
class SerXform extends BaseXform {
  ...
  render(xmlStream, model) {
    ...
    this.map['c:cat'].render(xmlStream, model.xValues);
    this.map['c:val'].render(xmlStream, model.yValues);
